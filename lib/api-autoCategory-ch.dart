...
Future<List> fetchCategoryTitlesCh() async {
  var convertDatatoJson;
  var isCacheExit =
  await APICacheManager().isAPICacheKeyExist("CategoryList_API_Ch");
  if (!isCacheExit) {
    ...
    var cacheData = await APICacheManager().getCacheData("CategoryList_API_Ch");
    // if (kDebugMode) {
    //   print("Cache hit");
    // }
