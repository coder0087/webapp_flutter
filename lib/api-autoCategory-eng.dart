...
Future<List> fetchCategoryTitlesEng() async {
  var convertDatatoJson;
  var isCacheExit =
  await APICacheManager().isAPICacheKeyExist("CategoryList_API_Eng");
  if (!isCacheExit) {
    ...
    var cacheData = await APICacheManager().getCacheData("CategoryList_API_Eng");
    // if (kDebugMode) {
    //   print("Cache hit");
    // }
